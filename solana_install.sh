...
<html dir="ltr" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>release.solana.com</title>
    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$690955016$-->
            <p><strong>release.solana.com</strong> unexpectedly closed the connection.</p>
          

          <!--?lit$690955016$-->
            <div id="suggestions-list">
              <p><!--?lit$690955016$-->Try:</p>
              <ul class="">
                <!--?lit$690955016$--><!---->
                  <li>Checking the connection</li>
                <!----><!---->
                  <li><a href="chrome-error://chromewebdata/#buttons" onclick="toggleHelpBox()">Checking the proxy and the firewall</a></li>
                <!----><!---->
          ...
          <div class="error-code"><!--?lit$690955016$-->ERR_CONNECTION_CLOSED</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-left">
        <div id="control-buttons">
          <!--?lit$690955016$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://release.solana.com/v1.18.15/install">
              <!--?lit$690955016$-->Reload
            </button>
    ...
    <!--?lit$690955016$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details"><strong>release.solana.com</strong> unexpectedly closed the connection.</div>
      </div>
